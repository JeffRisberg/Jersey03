...
public class CharityEndpointTest {
  ...
  public void testFetchList() {
    Invocation.Builder invocationBuilder = target.path("charities").request()
        .accept(MediaType.APPLICATION_JSON);

    try {
      String responseMsg = invocationBuilder.get(String.class);

      List<CharityEntity> charities = mapper
          .readValue(responseMsg, new TypeReference<List<CharityEntity>>() {
          });
  ...
  public void testFetchMissing() {
    Invocation.Builder invocationBuilder = target.path("charities/999").request()
        .accept(MediaType.APPLICATION_JSON);
  ...
  public void testDeleteValid() {
    ...
    try {
      ...
      for (CharityEntity charity : charities) {
        ...
        Invocation.Builder invocationBuilder2 = target.path("charities/" + id).request()
            .accept(MediaType.APPLICATION_JSON);
